...
<header>
  ...
  <div class="container">
    ...
    <form name="inscription" onsubmit="return validateForm()" method="post" action="editerprofil.php" class="modifier-profil">
...
<input type="text" id="entreprise" name="entreprise" value="<?php echo $startuper_info['nom_entreprise']; ?>">

<label for="adresse">Adresse de l'entreprise:</label>
<input type="text" id="adresse" name="adresse_entreprise" required value="<?php echo $startuper_info['adresse_entreprise']; ?>">

<label for="rc">Numéro Registre de Commerce (ex: A1234567890):</label>
<input type="text" id="rc" name="rc" onblur="validateRC()" value="<?php echo $startuper_info['numero_registre_commerce']; ?>">
